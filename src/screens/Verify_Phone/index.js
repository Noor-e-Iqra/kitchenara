...
const Verify_Phone = () => {
  ...
  return (
    <ImageBackground
      source={require('../../assets/images/background-auth-1.png')}
      ...
      <SafeAreaView style={{flex: 1, flexDirection: 'column'}}>
        <ScrollView style={{flex: 1, flexDirection: 'column'}}>
          ...
          {/* login form section */}
          <View
            style={{flex: 2, flexDirection: 'column', paddingHorizontal: 21}}>
            <View
            ...
            <Text
              ...
              We have sent an OTP to your mobile phone +6282******39
            </Text>
            ...
            <Timer text={['Resend code in ', ' s', 'Resend code']} />
      ...
      <Congratulations
        ...
        onPress={() => {
          setShowModal(false);
          navigation.navigate(routes.profile.cards);
        }}
      />
    </ImageBackground>
  );
